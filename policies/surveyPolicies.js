...
const policies = {
  put: [
    ...
    check('gender').isLength({ min: 0, max:100 }).withMessage("Maximum length exceeded (100 characters)").optional({checkFalsy: true}),
    check('age').isLength({ min: 0, max:100 }).withMessage("Maximum length exceeded (100 characters)").optional({checkFalsy: true}),
