...
import { VOICE_RETURN_SIGNAL_RECEIVED } from "../../ServerEventNames";
...
export async function onVoiceSendReturnSignal(client: Socket, payload: Payload) {
  ...
  getIOInstance().to(recipientVoice.socketId).emit(VOICE_RETURN_SIGNAL_RECEIVED, {
